...
var planets = {
    ...
    'mercury': {
        ...
        'material': new THREE.MeshPhongMaterial({map: mercury_texture, overdraw: 0.5}),
    ...
    'mars': {
        ...
        'material': new THREE.MeshPhongMaterial({map: mars_texture, overdraw: 0.5}),
    ...
    'jupiter': {
        ...
        'material': new THREE.MeshPhongMaterial({map: jupiter_texture, overdraw: 0.5}),
    ...
    'uranus': {
        ...
        'material': new THREE.MeshPhongMaterial({map: uranus_texture, overdraw: 0.5}),
